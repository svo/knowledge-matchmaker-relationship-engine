...
from knowledge_matchmaker_relationship_engine.shared.configuration import (
    ApplicationSettings,
...
class TestApplicationSettings:
    @patch("knowledge_matchmaker_relationship_engine.shared.configuration.get_resource_path")
    @patch("knowledge_matchmaker_relationship_engine.shared.configuration.load_properties_file")
...
class TestApplicationSettingProvider:
    @patch("knowledge_matchmaker_relationship_engine.shared.configuration.ApplicationSettings")

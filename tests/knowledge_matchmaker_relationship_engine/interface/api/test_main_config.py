...
from knowledge_matchmaker_relationship_engine.interface.api.main import main
...
class TestMainConfiguration:
    @patch("knowledge_matchmaker_relationship_engine.interface.api.main.uvicorn.run")
